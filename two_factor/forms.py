...
class MethodForm(forms.Form):
    method = forms.ChoiceField(label=_(""),
                               initial='generator',
...
class TOTPDeviceForm(forms.Form):
    token = forms.IntegerField(label=_("Token"), min_value=0, max_value=int('9' * totp_digits()), widget= forms.TextInput(attrs={'class':'main__input'}),)
